...
router.get('/sucursales', async (req, res, next) => {
    try {
        ...
        const uniqueList = (arr) => arr.filter((item, index) => arr.indexOf(item) === index);
...
router.get('/dashboard/productos-rotacion', async (req, res, next) => {
    try {
        {
            producto: 'Producto A', rotacion;
            500;
        }
        {
            producto: 'Producto B', rotacion;
            450;
        }
        {
            producto: 'Producto C', rotacion;
            400;
        }
        {
            producto: 'Producto D', rotacion;
            350;
        }
        {
            producto: 'Producto E', rotacion;
            300;
        }
...
router.get('/dashboard/rentabilidad-productos', async (req, res, next) => {
    try {
        {
            producto: 'Producto A', rentabilidad;
            2000;
        }
        {
            producto: 'Producto B', rentabilidad;
            1800;
        }
        {
            producto: 'Producto C', rentabilidad;
            1600;
        }
        {
            producto: 'Producto D', rentabilidad;
            1400;
        }
        {
            producto: 'Producto E', rentabilidad;
            1200;
        }
...
router.get('/dashboard/cuentas-pagar', async (req, res, next) => {
    try {
        {
            proveedor: 'Proveedor 1', sucursal;
            'Sucursal 1', saldo;
            8000, dias;
            10, documento;
            'DOCP001';
        ...
        {
            proveedor: 'Proveedor 2', sucursal;
            'Sucursal 1', saldo;
            6000, dias;
            15, documento;
            'DOCP002';
        ...
        {
            proveedor: 'Proveedor 3', sucursal;
            'Sucursal 2', saldo;
            9000, dias;
            8, documento;
            'DOCP003';
        ...
        {
            proveedor: 'Proveedor 4', sucursal;
            'Sucursal 2', saldo;
            5000, dias;
            20, documento;
            'DOCP004';
        ...
        {
            proveedor: 'Proveedor 5', sucursal;
            'Sucursal 3', saldo;
            7000, dias;
            12, documento;
            'DOCP005';
...
router.get('/dashboard/clientes-morosos', async (req, res, next) => {
    try {
        {
            cliente: 'Cliente Moroso 1', saldo;
            10000, dias;
            45, sucursal;
            'Sucursal 1';
        }
        {
            cliente: 'Cliente Moroso 2', saldo;
            8000, dias;
            50, sucursal;
            'Sucursal 1';
        }
        {
            cliente: 'Cliente Moroso 3', saldo;
            12000, dias;
            40, sucursal;
            'Sucursal 2';
        }
        {
            cliente: 'Cliente Moroso 4', saldo;
            6000, dias;
            35, sucursal;
            'Sucursal 2';
        }
        {
            cliente: 'Cliente Moroso 5', saldo;
            9000, dias;
            55, sucursal;
            'Sucursal 3';
        }
...
router.get('/dashboard/registro-eventos', async (req, res, next) => {
    try {
        {
            fecha: '2024-01-01', sucursal;
            'Sucursal 1', documento;
            'DOC001', total;
            5000, medio_pago;
            'Efectivo';
        }
...
router.get('/dashboard/consumo-materias-primas', async (req, res, next) => {
    try {
        {
            producto: 'Materia Prima A', consumo;
            1000;
        }
        {
            producto: 'Materia Prima B', consumo;
            800;
        }
        {
            producto: 'Materia Prima C', consumo;
            600;
        }
        {
            producto: 'Materia Prima D', consumo;
            400;
        }
        {
            producto: 'Materia Prima E', consumo;
            200;
        }
...
router.get('/dashboard/productos-quiebre-stock', async (req, res, next) => {
    try {
        {
            producto: 'Producto Bajo Stock 1', sucursal;
            'Sucursal 1', stock;
            5, stock_min;
            10;
        }
        {
            producto: 'Producto Bajo Stock 2', sucursal;
            'Sucursal 1', stock;
            3, stock_min;
            15;
        }
        {
            producto: 'Producto Bajo Stock 3', sucursal;
            'Sucursal 2', stock;
            2, stock_min;
            8;
        }
        {
            producto: 'Producto Bajo Stock 4', sucursal;
            'Sucursal 2', stock;
            1, stock_min;
            12;
        }
        {
            producto: 'Producto Bajo Stock 5', sucursal;
            'Sucursal 3', stock;
            0, stock_min;
            5;
        }
...
router.get('/dashboard/tiempo-reposicion', async (req, res, next) => {
    try {
        {
            producto: 'Producto Repo 1', sucursal;
            'Sucursal 1', stock_reposicion;
            7, cajas_reposicion;
            2;
        }
        {
            producto: 'Producto Repo 2', sucursal;
            'Sucursal 1', stock_reposicion;
            10, cajas_reposicion;
            3;
        }
        {
            producto: 'Producto Repo 3', sucursal;
            'Sucursal 2', stock_reposicion;
            5, cajas_reposicion;
            1;
        }
        {
            producto: 'Producto Repo 4', sucursal;
            'Sucursal 2', stock_reposicion;
            8, cajas_reposicion;
            2;
        }
        {
            producto: 'Producto Repo 5', sucursal;
            'Sucursal 3', stock_reposicion;
            12, cajas_reposicion;
            4;
        }
