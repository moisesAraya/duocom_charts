...
exports.TraceFactory = exports.TracePlugin = exports.TraceTrigger = exports.TraceTransaction = exports.TraceConnection = exports.XpbBuilder = exports.ExternalTrigger = exports.User = exports.Auth = exports.Statement = exports.ConfigManager = exports.PluginManager = exports.Status = void 0;
var Status;
(function (Status) {
...
})(PluginManager || (exports.PluginManager = PluginManager = {}));
var ConfigManager;
...
})(ConfigManager || (exports.ConfigManager = ConfigManager = {}));
var Statement;
(function (Statement) {
    ...
    Statement.PREPARE_PREFETCH_METADATA = Statement.PREPARE_PREFETCH_TYPE |
        (Statement.PREPARE_PREFETCH_FLAGS |
            (Statement.PREPARE_PREFETCH_INPUT_PARAMETERS | Statement.PREPARE_PREFETCH_OUTPUT_PARAMETERS));
    Statement.PREPARE_PREFETCH_ALL = Statement.PREPARE_PREFETCH_METADATA |
...
})(ExternalTrigger || (exports.ExternalTrigger = ExternalTrigger = {}));
var XpbBuilder;
(function (XpbBuilder) {
    XpbBuilder.DPB = 1;
    ...
    XpbBuilder.TPB = 4;
})(XpbBuilder || (exports.XpbBuilder = XpbBuilder = {}));
var TraceConnection;
(function (TraceConnection) {
    TraceConnection.KIND_DATABASE = 1;
    TraceConnection.KIND_SERVICE = 2;
})(TraceConnection || (exports.TraceConnection = TraceConnection = {}));
...
})(TraceTransaction || (exports.TraceTransaction = TraceTransaction = {}));
var TraceTrigger;
(function (TraceTrigger) {
    TraceTrigger.TYPE_ALL = 0;
    TraceTrigger.TYPE_BEFORE = 1;
    TraceTrigger.TYPE_AFTER = 2;
})(TraceTrigger || (exports.TraceTrigger = TraceTrigger = {}));
var TracePlugin;
...
})(TracePlugin || (exports.TracePlugin = TracePlugin = {}));
var TraceFactory;
...
})(TraceFactory || (exports.TraceFactory = TraceFactory = {}));
